...
def close_keystrokes():
  KEYSTROKES.close()
  if GYM:
    shutil.move('KEYSTROKES.tmp','KEYSTROKES.setup_traj_gym')  
  else:
...
'''
  ...
  if nmax<=0:
    ...
    sys.exit(1)
  if GYM:
    setupstates = defsetupstates
    INFOS['setupstates']=set(defsetupstates)
  else:
    while True:
...
'''
  ...
  if Couplings[INFOS['coupling']]['name']=='nacdr' or INFOS['gradcorrect'] or EkinCorrect[INFOS['ekincorrect']]['name']=='parallel_nac':
